...
namespace User_Registration
{
    ...
    {
        //string connectionString = @"DESKTOP-5BKJA0P\KAVEESHASQL; Initial Catalog = UserRegistrationDB; Integrated Security=True;";
        string connectionString = @"Data Source = DESKTOP-5BKJA0P\KAVEESHASQL; Initial Catalog = UserRegistrationDB;Integrated Security=True;";
            ...
            if(!IsPostBack)
            {
                ...
                if(!String.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    ...
                    using (SqlConnection sqlCon = new SqlConnection(connectionString))
                    {
                        ...
                        txtAddress.Text = dtbl.Rows[0][4].ToString();
                        ...
                        txtConfirmPassword.Text = dtbl.Rows[0][6].ToString();
                        txtConfirmPassword.Attributes.Add("value", dtbl.Rows[0][6].ToString());
                    }
                }
            }
        }
